...
plot(c(4.7, 6.35), c(-0.3, 0.9), axes=FALSE, type="n", xlab="Time (s)", ylab="")
title(ylab="ECG (mV)", adj=0.65, line=3)
lines((1:length(esa))/ 2000, esa)
axis(2, at=c(0, 0.5))
axis(1, line=-1.5, padj=-1, at=c(4.7, 4.95, 5.2), labels=c("", "0,5 s", ""), lwd=3, lwd.ticks=0, cex.axis=1.2)
...
interTA(pks[26]/2000, pks[28]/2000, 0.855)
