...
Lors d'un enregistrement, des artéfacts peuvent apparaître sur le tracé, qui n'ont pas comme origine l'activité électrique cardiaques. Ces artéfacts peuvent rendre plus difficile la lecture des tracés, et altérer l'efficacité des traitements automatiques.

\begin{description}
\item [Artefects de mouvement :] 
\item
\end{description}
...
La FA est caractérisée sur un tracé ECG par les caractéristiques suivantes :
\begin{enumerate}
